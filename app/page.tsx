    ...
    <>
      ...
      <section className="hero">
        <div className="hero-inner">
          ...
          <p className="hero-sub">
            The home for Thai students and friends at UBC. Join the family and
            carry your digital membership pass in Apple Wallet.
          </p>
      ...
      <section className="section quote-section">
        <blockquote className="quote">
          <p>
            “With my Roon Pees, Roon Norngs and friends there for me, I feel
            right at home. Aiyara is more than a club — it&apos;s a family.”
          </p>
      ...
      <section id="contact" className="section section-alt">
        ...
        <p className="contact-links">
          <a href="mailto:ubcthaiaiyara@gmail.com">ubcthaiaiyara@gmail.com</a>
          <a href="https://www.instagram.com/ubcthaiaiyara">Instagram</a>
          <a href="https://www.facebook.com/ubcthaiaiyara">Facebook</a>
        </p>
        <Link className="button" href="/join">
          Become a member
        </Link>
